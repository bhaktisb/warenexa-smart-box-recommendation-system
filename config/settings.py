...
_INSECURE_DEV_SECRET_KEY = (
    "django-insecure-r0x5z*-ec34n2mgs11v_78d#l2!+h#y6dnk*0&$gix0it@%7-!"
)
...
if not DEBUG:
    ...
    if os.environ.get("DJANGO_HSTS_SECONDS"):
        SECURE_HSTS_SECONDS = int(os.environ["DJANGO_HSTS_SECONDS"])
